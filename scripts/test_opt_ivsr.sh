...
#
# BUILD HYGIENE: the dump driver binary is cached under build/fuzz_ad_codegen and
# does NOT auto-rebuild on .ad change; we wipe it so the test exercises the
# CURRENT opt.ad / codegen.ad.
set -uo pipefail
