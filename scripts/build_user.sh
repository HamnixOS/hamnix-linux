...
build_adder_user hampkgscene          # scene-file DE Package Manager ("Software"): searchable package list + detail pane + Install/Remove/Upgrade over the native hpm engine (lib/hampkgcore, dual-target)
