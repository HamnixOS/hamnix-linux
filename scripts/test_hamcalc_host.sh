...
assert_grep '^fill 8 60 40 35 #c8c4bc'          "top-left key face geometry"
...
assert_grep '^PIX 12 64 #c8c4bc'                "raster key-face pixel = button grey"
# --- MATE 3D bevel on the shared panel button (top-left key @8,60 40x35) ---
assert_grep '^PIX 8 60 #5f5b55'                 "bevel: dark outer frame at button corner"
assert_grep '^PIX 20 61 #f0ede6'                "bevel: light highlight on the top edge"
assert_grep '^PIX 9 72 #f0ede6'                 "bevel: light highlight on the left edge"
assert_grep '^PIX 20 93 #7a756e'                "bevel: dark shadow on the bottom edge"
assert_grep '^PIX 46 72 #7a756e'                "bevel: dark shadow on the right edge"
