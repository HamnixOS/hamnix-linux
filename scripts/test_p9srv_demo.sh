...
# The legacy driver did `( sleep N; printf '/bin/test_p9srv_demo\n'; ... ) | qemu`:
...
# `[p9demo] FAIL:` (or a started-but-never-PASSed run while the shell demonstrably
# survived) is FAIL, and only an observed `[p9demo] PASS` is a green.
...
TEST_SRC=tests/test_p9srv_demo.ad
