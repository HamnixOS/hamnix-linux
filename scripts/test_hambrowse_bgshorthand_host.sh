...
assert_grep 'FILL 2 3 100 700 #33cc99'  "colour as the LAST token (after no-repeat)"
assert_grep 'FILL 4 5 100 700 #cc3366'  "colour after a '/' (position/size shorthand)"
assert_grep 'FILL 6 7 100 700 #ff0000'  "colour first with a url() present"
assert_grep 'FILL 8 9 100 700 #4682b4'  "NAMED colour after a repeat keyword (steelblue)"
assert_grep 'FILL 10 11 100 700 #0a78c8' "rgb() colour mid-shorthand (internal spaces)"
